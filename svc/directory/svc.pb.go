...
type LookupEntitiesRequest struct {
	...
	//	*LookupEntitiesRequest_DisplayName
	Key                  isLookupEntitiesRequest_Key `protobuf_oneof:"key"`
...
type isLookupEntitiesRequest_Key interface {
	isLookupEntitiesRequest_Key()
...
type LookupEntitiesRequest_DisplayName struct {
	DisplayName string `protobuf:"bytes,11,opt,name=display_name,proto3,oneof"`
}

func (*LookupEntitiesRequest_EntityID) isLookupEntitiesRequest_Key()      {}
func (*LookupEntitiesRequest_ExternalID) isLookupEntitiesRequest_Key()    {}
func (*LookupEntitiesRequest_BatchEntityID) isLookupEntitiesRequest_Key() {}
func (*LookupEntitiesRequest_AccountID) isLookupEntitiesRequest_Key()     {}
func (*LookupEntitiesRequest_DisplayName) isLookupEntitiesRequest_Key()   {}

func (m *LookupEntitiesRequest) GetKey() isLookupEntitiesRequest_Key {
	if m != nil {
		return m.Key
	}
	return nil
...
func (m *LookupEntitiesRequest) GetEntityID() string {
	if x, ok := m.GetKey().(*LookupEntitiesRequest_EntityID); ok {
		return x.EntityID
	}
	return ""
}
...
func (m *LookupEntitiesRequest) GetExternalID() string {
	if x, ok := m.GetKey().(*LookupEntitiesRequest_ExternalID); ok {
		return x.ExternalID
	}
	return ""
}
...
func (m *LookupEntitiesRequest) GetBatchEntityID() *IDList {
	if x, ok := m.GetKey().(*LookupEntitiesRequest_BatchEntityID); ok {
...
func (m *LookupEntitiesRequest) GetAccountID() string {
	if x, ok := m.GetKey().(*LookupEntitiesRequest_AccountID); ok {
		return x.AccountID
	}
	return ""
}

func (m *LookupEntitiesRequest) GetDisplayName() string {
	if x, ok := m.GetKey().(*LookupEntitiesRequest_DisplayName); ok {
...
func (*LookupEntitiesRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _LookupEntitiesRequest_OneofMarshaler, _LookupEntitiesRequest_OneofUnmarshaler, _LookupEntitiesRequest_OneofSizer, []interface{}{
		...
		(*LookupEntitiesRequest_DisplayName)(nil),
	}
}
...
func _LookupEntitiesRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *LookupEntitiesRequest_DisplayName:
		_ = b.EncodeVarint(11<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.DisplayName)
	case nil:
	default:
		return fmt.Errorf("LookupEntitiesRequest.Key has unexpected type %T", x)
	}
	return nil
}
...
func _LookupEntitiesRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*LookupEntitiesRequest)
	switch tag {
	case 2: // key.entity_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Key = &LookupEntitiesRequest_EntityID{x}
		return true, err
	case 3: // key.external_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Key = &LookupEntitiesRequest_ExternalID{x}
		return true, err
	case 6: // key.batch_entity_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(IDList)
		err := b.DecodeMessage(msg)
		m.Key = &LookupEntitiesRequest_BatchEntityID{msg}
		return true, err
	case 9: // key.account_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Key = &LookupEntitiesRequest_AccountID{x}
		return true, err
	case 11: // key.display_name
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Key = &LookupEntitiesRequest_DisplayName{x}
		return true, err
	default:
		return false, nil
	}
...
type ProfileRequest struct {
	...
	Key isProfileRequest_Key `protobuf_oneof:"key"`
}
...
type isProfileRequest_Key interface {
	isProfileRequest_Key()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
func (*ProfileRequest_EntityID) isProfileRequest_Key()  {}
func (*ProfileRequest_ProfileID) isProfileRequest_Key() {}

func (m *ProfileRequest) GetKey() isProfileRequest_Key {
	if m != nil {
		return m.Key
	}
	return nil
...
func (m *ProfileRequest) GetEntityID() string {
	if x, ok := m.GetKey().(*ProfileRequest_EntityID); ok {
		return x.EntityID
	}
	return ""
}
...
func (m *ProfileRequest) GetProfileID() string {
	if x, ok := m.GetKey().(*ProfileRequest_ProfileID); ok {
		return x.ProfileID
	}
	return ""
}
...
func _ProfileRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("ProfileRequest.Key has unexpected type %T", x)
	}
	return nil
}
...
func _ProfileRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // key.entity_id
		...
		x, err := b.DecodeStringBytes()
		m.Key = &ProfileRequest_EntityID{x}
		return true, err
	case 3: // key.profile_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Key = &ProfileRequest_ProfileID{x}
		return true, err
	default:
		return false, nil
	}
...
func (this *LookupEntitiesRequest_DisplayName) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*LookupEntitiesRequest_DisplayName)
	if !ok {
		that2, ok := that.(LookupEntitiesRequest_DisplayName)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *LookupEntitiesRequest_DisplayName) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&directory.LookupEntitiesRequest_DisplayName{` +
...
func (m *LookupEntitiesRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Key != nil {
		nn8, err := m.Key.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn8
...
func (m *LookupEntitiesRequest_DisplayName) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x5a
	i++
	i = encodeVarintSvc(dAtA, i, uint64(len(m.DisplayName)))
...
func (m *ProfileRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Key != nil {
		nn43, err := m.Key.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn43
...
func (m *LookupEntitiesRequest_DisplayName) Size() (n int) {
	var l int
	_ = l
	l = len(m.DisplayName)
	n += 1 + l + sovSvc(uint64(l))
...
func (this *LookupEntitiesRequest_DisplayName) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LookupEntitiesRequest_DisplayName{`,
		`DisplayName:` + fmt.Sprintf("%v", this.DisplayName) + `,`,
		`}`,
	}, "")
	return s
...
func (m *LookupEntitiesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Key = &LookupEntitiesRequest_EntityID{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Key = &LookupEntitiesRequest_ExternalID{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
		...
		case 6:
			...
			m.Key = &LookupEntitiesRequest_BatchEntityID{v}
			iNdEx = postIndex
		case 7:
			if wireType == 2 {
				var packedLen int
		...
		case 9:
			...
			m.Key = &LookupEntitiesRequest_AccountID{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
		...
		case 11:
			...
			m.Key = &LookupEntitiesRequest_DisplayName{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSvc(dAtA[iNdEx:])
...
func (m *ProfileRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Key = &ProfileRequest_EntityID{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Key = &ProfileRequest_ProfileID{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSvc(dAtA[iNdEx:])
...
var fileDescriptorSvc = []byte{
	...
	,
}
