...
type VendorAccount struct {
	...
	ChangeState VendorAccountChangeState `protobuf:"varint,4,opt,name=change_state,json=changeState,proto3,enum=payments.VendorAccountChangeState" json:"change_state,omitempty"`
...
type VendorAccount_StripeAccount struct {
	StripeAccount *StripeAccount `protobuf:"bytes,7,opt,name=stripe_account,json=stripeAccount,oneof"`
}
...
type StripeCard struct {
	ID                 string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	TokenizationMethod string `protobuf:"bytes,2,opt,name=tokenization_method,json=tokenizationMethod,proto3" json:"tokenization_method,omitempty"`
...
type PaymentMethod struct {
	...
	ChangeState PaymentMethodChangeState `protobuf:"varint,5,opt,name=change_state,json=changeState,proto3,enum=payments.PaymentMethodChangeState" json:"change_state,omitempty"`
	StorageType PaymentMethodStorageType `protobuf:"varint,6,opt,name=storage_type,json=storageType,proto3,enum=payments.PaymentMethodStorageType" json:"storage_type,omitempty"`
...
type PaymentMethod_StripeCard struct {
	StripeCard *StripeCard `protobuf:"bytes,8,opt,name=stripe_card,json=stripeCard,oneof"`
}
...
type Payment struct {
	ID                     string             `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	RequestingEntityID     string             `protobuf:"bytes,2,opt,name=requesting_entity_id,json=requestingEntityId,proto3" json:"requesting_entity_id,omitempty"`
	PaymentMethod          *PaymentMethod     `protobuf:"bytes,3,opt,name=payment_method,json=paymentMethod" json:"payment_method,omitempty"`
	...
	ChangeState            PaymentChangeState `protobuf:"varint,5,opt,name=change_state,json=changeState,proto3,enum=payments.PaymentChangeState" json:"change_state,omitempty"`
	...
	ProcessorTransactionID string             `protobuf:"bytes,11,opt,name=processor_transaction_id,json=processorTransactionId,proto3" json:"processor_transaction_id,omitempty"`
	ProcessorStatusMessage string             `protobuf:"bytes,12,opt,name=processor_status_message,json=processorStatusMessage,proto3" json:"processor_status_message,omitempty"`
}
...
type ConnectVendorAccountRequest_StripeRequest struct {
	StripeRequest *StripeAccountConnectRequest `protobuf:"bytes,3,opt,name=stripe_request,json=stripeRequest,oneof"`
}
...
type ConnectVendorAccountResponse struct {
	VendorAccounts []*VendorAccount `protobuf:"bytes,1,rep,name=vendor_accounts,json=vendorAccounts" json:"vendor_accounts,omitempty"`
}
...
type UpdateVendorAccountRequest struct {
	VendorAccountID string                   `protobuf:"bytes,1,opt,name=vendor_account_id,json=vendorAccountId,proto3" json:"vendor_account_id,omitempty"`
	...
	ChangeState     VendorAccountChangeState `protobuf:"varint,3,opt,name=change_state,json=changeState,proto3,enum=payments.VendorAccountChangeState" json:"change_state,omitempty"`
}
...
type CreatePaymentMethodRequest struct {
	...
	StorageType PaymentMethodStorageType `protobuf:"varint,3,opt,name=storage_type,json=storageType,proto3,enum=payments.PaymentMethodStorageType" json:"storage_type,omitempty"`
...
type CreatePaymentMethodRequest_StripeCard struct {
	StripeCard *StripeCardCreateRequest `protobuf:"bytes,5,opt,name=stripe_card,json=stripeCard,oneof"`
}
...
type CreatePaymentMethodResponse struct {
	PaymentMethods []*PaymentMethod `protobuf:"bytes,1,rep,name=payment_methods,json=paymentMethods" json:"payment_methods,omitempty"`
}
...
type CreatePaymentRequest struct {
	RequestingEntityID string `protobuf:"bytes,1,opt,name=requesting_entity_id,json=requestingEntityId,proto3" json:"requesting_entity_id,omitempty"`
...
type PaymentMethodResponse struct {
	PaymentMethod *PaymentMethod `protobuf:"bytes,1,opt,name=payment_method,json=paymentMethod" json:"payment_method,omitempty"`
}
...
func (this *Payment) Equal(that interface{}) bool {
	...
	if this.ProcessorTransactionID != that1.ProcessorTransactionID {
		return false
	}
	if this.ProcessorStatusMessage != that1.ProcessorStatusMessage {
		return false
	}
	return true
}
...
func (this *Payment) GoString() string {
	...
	s = append(s, "ProcessorTransactionID: "+fmt.Sprintf("%#v", this.ProcessorTransactionID)+",\n")
	s = append(s, "ProcessorStatusMessage: "+fmt.Sprintf("%#v", this.ProcessorStatusMessage)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Payment) Size() (n int) {
	...
	l = len(m.ProcessorTransactionID)
	if l > 0 {
		n += 1 + l + sovSvc(uint64(l))
	}
	l = len(m.ProcessorStatusMessage)
	if l > 0 {
		n += 1 + l + sovSvc(uint64(l))
	}
	return n
...
func (this *Payment) String() string {
	...
	s := strings.Join([]string{`&Payment{`,
		...
		`ProcessorTransactionID:` + fmt.Sprintf("%v", this.ProcessorTransactionID) + `,`,
		`ProcessorStatusMessage:` + fmt.Sprintf("%v", this.ProcessorStatusMessage) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Payment) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProcessorTransactionID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProcessorStatusMessage", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorSvc = []byte{
	...
	,
}
