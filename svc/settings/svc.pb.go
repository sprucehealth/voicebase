...
const (
	TextType_FREE_TEXT TextType = 0
	TextType_PHONE     TextType = 1
)
...
func (TextType) EnumDescriptor() ([]byte, []int) { return fileDescriptorSvc, []int{2} }
...
type StringListValue struct {
	...
	DisplayValues []string `protobuf:"bytes,2,rep,name=display_values" json:"display_values,omitempty"`
}
...
type StringListRequirements struct {
	TextRequirements *TextRequirements `protobuf:"bytes,1,opt,name=text_requirements" json:"text_requirements,omitempty"`
	MinValues        int32             `protobuf:"varint,2,opt,name=min_values,proto3" json:"min_values,omitempty"`
	MaxValues        int32             `protobuf:"varint,3,opt,name=max_values,proto3" json:"max_values,omitempty"`
}
...
type TextValue struct {
	...
	DisplayValue string `protobuf:"bytes,2,opt,name=display_value,proto3" json:"display_value,omitempty"`
}
...
type TextRequirements struct {
	MatchRegexp string   `protobuf:"bytes,1,opt,name=match_regexp,proto3" json:"match_regexp,omitempty"`
	TextType    TextType `protobuf:"varint,2,opt,name=text_type,proto3,enum=settings.TextType" json:"text_type,omitempty"`
}
...
func (m *SetValueResponse) GetValue() *Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("settings.TextType", TextType_name, TextType_value)
}
...
func (this *StringListValue) Equal(that interface{}) bool {
	...
	if len(this.DisplayValues) != len(that1.DisplayValues) {
		return false
	}
	for i := range this.DisplayValues {
		if this.DisplayValues[i] != that1.DisplayValues[i] {
			return false
		}
	}
	return true
...
func (this *TextRequirements) Equal(that interface{}) bool {
	...
	if this.TextType != that1.TextType {
		return false
	}
	return true
}
...
func (this *StringListValue) GoString() string {
	...
	s = append(s, "DisplayValues: "+fmt.Sprintf("%#v", this.DisplayValues)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *TextValue) GoString() string {
	...
	s = append(s, "Value: "+fmt.Sprintf("%#v", this.Value)+",\n")
	s = append(s, "DisplayValue: "+fmt.Sprintf("%#v", this.DisplayValue)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *TextRequirements) GoString() string {
	...
	s = append(s, "TextType: "+fmt.Sprintf("%#v", this.TextType)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *StringListValue) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DisplayValues) > 0 {
		for _, s := range m.DisplayValues {
			dAtA[i] = 0x12
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *TextValue) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DisplayValue) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSvc(dAtA, i, uint64(len(m.DisplayValue)))
		i += copy(dAtA[i:], m.DisplayValue)
	}
	return i, nil
}
...
func (m *TextRequirements) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TextType != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintSvc(dAtA, i, uint64(m.TextType))
	}
	return i, nil
}
...
func (this *StringListValue) String() string {
	...
	s := strings.Join([]string{`&StringListValue{`,
		...
		`DisplayValues:` + fmt.Sprintf("%v", this.DisplayValues) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *TextValue) String() string {
	...
	s := strings.Join([]string{`&TextValue{`,
		`Value:` + fmt.Sprintf("%v", this.Value) + `,`,
		`DisplayValue:` + fmt.Sprintf("%v", this.DisplayValue) + `,`,
		`}`,
	}, "")
	return s
}
func (this *TextRequirements) String() string {
	...
	s := strings.Join([]string{`&TextRequirements{`,
		...
		`TextType:` + fmt.Sprintf("%v", this.TextType) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *StringListValue) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisplayValues", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DisplayValues = append(m.DisplayValues, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSvc(dAtA[iNdEx:])
...
func (m *TextRequirements) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TextType", wireType)
			}
			m.TextType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TextType |= (TextType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorSvc = []byte{
	...
	,
}
