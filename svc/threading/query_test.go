...
func TestQueries(t *testing.T) {
	cases := []*struct {
		...
		{s: "type:standard", q: &Query{Expressions: []*Expr{{Value: &Expr_ThreadType_{ThreadType: EXPR_THREAD_TYPE_PATIENT_STANDARD}}}}},
		{s: "type:secure", q: &Query{Expressions: []*Expr{{Value: &Expr_ThreadType_{ThreadType: EXPR_THREAD_TYPE_PATIENT_SECURE}}}}},
