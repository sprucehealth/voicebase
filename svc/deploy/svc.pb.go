...
type EnvironmentsRequest struct {
	...
	//	*EnvironmentsRequest_DeployableGroupID
	//	*EnvironmentsRequest_EnvironmentID
	By isEnvironmentsRequest_By `protobuf_oneof:"by"`
}
...
type isEnvironmentsRequest_By interface {
	isEnvironmentsRequest_By()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type EnvironmentsRequest_DeployableGroupID struct {
	DeployableGroupID string `protobuf:"bytes,1,opt,name=deployable_group_id,json=deployableGroupId,proto3,oneof"`
}
type EnvironmentsRequest_EnvironmentID struct {
	EnvironmentID string `protobuf:"bytes,2,opt,name=environment_id,json=environmentId,proto3,oneof"`
}

func (*EnvironmentsRequest_DeployableGroupID) isEnvironmentsRequest_By() {}
func (*EnvironmentsRequest_EnvironmentID) isEnvironmentsRequest_By()     {}

func (m *EnvironmentsRequest) GetBy() isEnvironmentsRequest_By {
	if m != nil {
		return m.By
	}
	return nil
...
func (m *EnvironmentsRequest) GetDeployableGroupID() string {
	if x, ok := m.GetBy().(*EnvironmentsRequest_DeployableGroupID); ok {
		return x.DeployableGroupID
	}
	return ""
}

func (m *EnvironmentsRequest) GetEnvironmentID() string {
	if x, ok := m.GetBy().(*EnvironmentsRequest_EnvironmentID); ok {
		return x.EnvironmentID
	}
	return ""
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*EnvironmentsRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _EnvironmentsRequest_OneofMarshaler, _EnvironmentsRequest_OneofUnmarshaler, _EnvironmentsRequest_OneofSizer, []interface{}{
		(*EnvironmentsRequest_DeployableGroupID)(nil),
		(*EnvironmentsRequest_EnvironmentID)(nil),
	}
}

func _EnvironmentsRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*EnvironmentsRequest)
	// by
	switch x := m.By.(type) {
	case *EnvironmentsRequest_DeployableGroupID:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.DeployableGroupID)
	case *EnvironmentsRequest_EnvironmentID:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.EnvironmentID)
	case nil:
	default:
		return fmt.Errorf("EnvironmentsRequest.By has unexpected type %T", x)
	}
	return nil
}

func _EnvironmentsRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*EnvironmentsRequest)
	switch tag {
	case 1: // by.deployable_group_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.By = &EnvironmentsRequest_DeployableGroupID{x}
		return true, err
	case 2: // by.environment_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.By = &EnvironmentsRequest_EnvironmentID{x}
		return true, err
	default:
		return false, nil
	}
...
func _EnvironmentsRequest_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*EnvironmentsRequest)
	// by
	switch x := m.By.(type) {
	case *EnvironmentsRequest_DeployableGroupID:
		n += proto.SizeVarint(1<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(len(x.DeployableGroupID)))
		n += len(x.DeployableGroupID)
	case *EnvironmentsRequest_EnvironmentID:
...
type DeployablesRequest struct {
	// Types that are valid to be assigned to By:
	//	*DeployablesRequest_DeployableGroupID
	//	*DeployablesRequest_DeployableID
	By isDeployablesRequest_By `protobuf_oneof:"by"`
}
...
type isDeployablesRequest_By interface {
	isDeployablesRequest_By()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type DeployablesRequest_DeployableGroupID struct {
	DeployableGroupID string `protobuf:"bytes,1,opt,name=deployable_group_id,json=deployableGroupId,proto3,oneof"`
}
type DeployablesRequest_DeployableID struct {
	DeployableID string `protobuf:"bytes,2,opt,name=deployable_id,json=deployableId,proto3,oneof"`
}

func (*DeployablesRequest_DeployableGroupID) isDeployablesRequest_By() {}
func (*DeployablesRequest_DeployableID) isDeployablesRequest_By()      {}

func (m *DeployablesRequest) GetBy() isDeployablesRequest_By {
	if m != nil {
		return m.By
	}
	return nil
...
func (m *DeployablesRequest) GetDeployableGroupID() string {
	if x, ok := m.GetBy().(*DeployablesRequest_DeployableGroupID); ok {
		return x.DeployableGroupID
	}
	return ""
}

func (m *DeployablesRequest) GetDeployableID() string {
	if x, ok := m.GetBy().(*DeployablesRequest_DeployableID); ok {
		return x.DeployableID
	}
	return ""
}

// XXX_OneofFuncs is for the internal use of the proto package.
func (*DeployablesRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _DeployablesRequest_OneofMarshaler, _DeployablesRequest_OneofUnmarshaler, _DeployablesRequest_OneofSizer, []interface{}{
		(*DeployablesRequest_DeployableGroupID)(nil),
		(*DeployablesRequest_DeployableID)(nil),
	}
}

func _DeployablesRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*DeployablesRequest)
	// by
	switch x := m.By.(type) {
	case *DeployablesRequest_DeployableGroupID:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.DeployableGroupID)
	case *DeployablesRequest_DeployableID:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.DeployableID)
	case nil:
	default:
		return fmt.Errorf("DeployablesRequest.By has unexpected type %T", x)
	}
	return nil
}

func _DeployablesRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*DeployablesRequest)
	switch tag {
	case 1: // by.deployable_group_id
		if wire != proto.WireBytes {
		...
		x, err := b.DecodeStringBytes()
		m.By = &DeployablesRequest_DeployableGroupID{x}
		return true, err
	case 2: // by.deployable_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.By = &DeployablesRequest_DeployableID{x}
		return true, err
	default:
		return false, nil
	}
...
func _DeployablesRequest_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*DeployablesRequest)
	// by
	switch x := m.By.(type) {
	case *DeployablesRequest_DeployableGroupID:
	...
	case *DeployablesRequest_DeployableID:
		n += proto.SizeVarint(2<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(len(x.DeployableID)))
		n += len(x.DeployableID)
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
	}
...
func (this *EnvironmentsRequest_DeployableGroupID) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*EnvironmentsRequest_DeployableGroupID)
	if !ok {
		that2, ok := that.(EnvironmentsRequest_DeployableGroupID)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *EnvironmentsRequest_EnvironmentID) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*EnvironmentsRequest_EnvironmentID)
	if !ok {
		that2, ok := that.(EnvironmentsRequest_EnvironmentID)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *DeployablesRequest_DeployableGroupID) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*DeployablesRequest_DeployableGroupID)
	if !ok {
		that2, ok := that.(DeployablesRequest_DeployableGroupID)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *DeployablesRequest_DeployableID) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*DeployablesRequest_DeployableID)
	if !ok {
		that2, ok := that.(DeployablesRequest_DeployableID)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *EnvironmentsRequest_DeployableGroupID) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&deploy.EnvironmentsRequest_DeployableGroupID{` +
		`DeployableGroupID:` + fmt.Sprintf("%#v", this.DeployableGroupID) + `}`}, ", ")
	return s
}
func (this *EnvironmentsRequest_EnvironmentID) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&deploy.EnvironmentsRequest_EnvironmentID{` +
		`EnvironmentID:` + fmt.Sprintf("%#v", this.EnvironmentID) + `}`}, ", ")
	return s
}
...
func (this *DeployablesRequest_DeployableGroupID) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&deploy.DeployablesRequest_DeployableGroupID{` +
		`DeployableGroupID:` + fmt.Sprintf("%#v", this.DeployableGroupID) + `}`}, ", ")
	return s
}
func (this *DeployablesRequest_DeployableID) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&deploy.DeployablesRequest_DeployableID{` +
...
func (m *EnvironmentsRequest_DeployableGroupID) Size() (n int) {
	var l int
	_ = l
	l = len(m.DeployableGroupID)
	n += 1 + l + sovSvc(uint64(l))
...
func (m *EnvironmentsRequest_EnvironmentID) Size() (n int) {
	var l int
	_ = l
	l = len(m.EnvironmentID)
	n += 1 + l + sovSvc(uint64(l))
...
func (m *DeployablesRequest_DeployableGroupID) Size() (n int) {
	var l int
	_ = l
	l = len(m.DeployableGroupID)
	n += 1 + l + sovSvc(uint64(l))
...
func (m *DeployablesRequest_DeployableID) Size() (n int) {
	var l int
	_ = l
	l = len(m.DeployableID)
	n += 1 + l + sovSvc(uint64(l))
...
func (this *EnvironmentsRequest_DeployableGroupID) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&EnvironmentsRequest_DeployableGroupID{`,
		`DeployableGroupID:` + fmt.Sprintf("%v", this.DeployableGroupID) + `,`,
		`}`,
	}, "")
	return s
}
func (this *EnvironmentsRequest_EnvironmentID) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&EnvironmentsRequest_EnvironmentID{`,
		`EnvironmentID:` + fmt.Sprintf("%v", this.EnvironmentID) + `,`,
		`}`,
	}, "")
	return s
...
func (this *DeployablesRequest_DeployableGroupID) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DeployablesRequest_DeployableGroupID{`,
		`DeployableGroupID:` + fmt.Sprintf("%v", this.DeployableGroupID) + `,`,
		`}`,
	}, "")
	return s
}
func (this *DeployablesRequest_DeployableID) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DeployablesRequest_DeployableID{`,
		`DeployableID:` + fmt.Sprintf("%v", this.DeployableID) + `,`,
		`}`,
	}, "")
	return s
...
var fileDescriptorSvc = []byte{
	...
	,
}
