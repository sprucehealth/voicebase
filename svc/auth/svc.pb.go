...
/*
	...
	It has these top-level messages:
		...
		UpdateAccountContactsRequest
		UpdateAccountContactsResponse
*/
package auth
...
func (*GetAccountRequest_Email) isGetAccountRequest_Key() {}
...
func (m *GetAccountRequest) GetID() string {
	if x, ok := m.GetKey().(*GetAccountRequest_ID); ok {
		return x.ID
	}
	return ""
}
...
func (m *GetAccountRequest) GetEmail() string {
	if x, ok := m.GetKey().(*GetAccountRequest_Email); ok {
		return x.Email
	}
	return ""
}
...
func (*GetAccountRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _GetAccountRequest_OneofMarshaler, _GetAccountRequest_OneofUnmarshaler, _GetAccountRequest_OneofSizer, []interface{}{
		(*GetAccountRequest_ID)(nil),
		(*GetAccountRequest_Email)(nil),
	}
}

func _GetAccountRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*GetAccountRequest)
	// key
	switch x := m.Key.(type) {
	case *GetAccountRequest_ID:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.ID)
	case *GetAccountRequest_Email:
		_ = b.EncodeVarint(3<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.Email)
	case nil:
	default:
		return fmt.Errorf("GetAccountRequest.Key has unexpected type %T", x)
	}
	return nil
}

func _GetAccountRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*GetAccountRequest)
	switch tag {
	case 2: // key.id
	...
	case 3: // key.email
		...
		x, err := b.DecodeStringBytes()
		m.Key = &GetAccountRequest_Email{x}
		return true, err
	default:
		return false, nil
	}
...
func _GetAccountRequest_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*GetAccountRequest)
	// key
	switch x := m.Key.(type) {
	case *GetAccountRequest_ID:
...
func (*GetAccountContactsRequest) ProtoMessage()               {}
func (*GetAccountContactsRequest) Descriptor() ([]byte, []int) { return fileDescriptorSvc, []int{35} }
...
func (*GetAccountContactsResponse) ProtoMessage()               {}
func (*GetAccountContactsResponse) Descriptor() ([]byte, []int) { return fileDescriptorSvc, []int{36} }
...
func (m *UpdateAccountContactsRequest) Reset()                    { *m = UpdateAccountContactsRequest{} }
func (*UpdateAccountContactsRequest) ProtoMessage()               {}
func (*UpdateAccountContactsRequest) Descriptor() ([]byte, []int) { return fileDescriptorSvc, []int{37} }

// UpdateAccountContactsResponse represents the response from a message UpdateAccountContacts request
type UpdateAccountContactsResponse struct {
}

func (m *UpdateAccountContactsResponse) Reset()      { *m = UpdateAccountContactsResponse{} }
func (*UpdateAccountContactsResponse) ProtoMessage() {}
func (*UpdateAccountContactsResponse) Descriptor() ([]byte, []int) {
...
func init() {
	...
	proto.RegisterType((*GetAccountContactsRequest)(nil), "auth.GetAccountContactsRequest")
	proto.RegisterType((*GetAccountContactsResponse)(nil), "auth.GetAccountContactsResponse")
	proto.RegisterType((*UpdateAccountContactsRequest)(nil), "auth.UpdateAccountContactsRequest")
	proto.RegisterType((*UpdateAccountContactsResponse)(nil), "auth.UpdateAccountContactsResponse")
...
func (this *GetAccountRequest_ID) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*GetAccountRequest_ID)
	if !ok {
		that2, ok := that.(GetAccountRequest_ID)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetAccountRequest_Email) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*GetAccountRequest_Email)
	if !ok {
		that2, ok := that.(GetAccountRequest_Email)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetAccountContactsRequest) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*GetAccountContactsRequest)
	if !ok {
		that2, ok := that.(GetAccountContactsRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetAccountContactsResponse) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*GetAccountContactsResponse)
	if !ok {
		that2, ok := that.(GetAccountContactsResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UpdateAccountContactsRequest) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*UpdateAccountContactsRequest)
	if !ok {
		that2, ok := that.(UpdateAccountContactsRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UpdateAccountContactsResponse) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*UpdateAccountContactsResponse)
	if !ok {
		that2, ok := that.(UpdateAccountContactsResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetAccountRequest_ID) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&auth.GetAccountRequest_ID{` +
		`ID:` + fmt.Sprintf("%#v", this.ID) + `}`}, ", ")
	return s
}
func (this *GetAccountRequest_Email) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&auth.GetAccountRequest_Email{` +
...
func (this *GetAccountContactsRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&auth.GetAccountContactsRequest{")
	s = append(s, "AccountID: "+fmt.Sprintf("%#v", this.AccountID)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *GetAccountContactsResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&auth.GetAccountContactsResponse{")
	s = append(s, "Email: "+fmt.Sprintf("%#v", this.Email)+",\n")
	s = append(s, "PhoneNumber: "+fmt.Sprintf("%#v", this.PhoneNumber)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *UpdateAccountContactsRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&auth.UpdateAccountContactsRequest{")
	s = append(s, "AccountID: "+fmt.Sprintf("%#v", this.AccountID)+",\n")
	s = append(s, "PhoneNumber: "+fmt.Sprintf("%#v", this.PhoneNumber)+",\n")
	s = append(s, "Email: "+fmt.Sprintf("%#v", this.Email)+",\n")
	s = append(s, "}")
...
func (this *UpdateAccountContactsResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&auth.UpdateAccountContactsResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
type AuthClient interface {
	...
	GetAccountContacts(ctx context.Context, in *GetAccountContactsRequest, opts ...grpc.CallOption) (*GetAccountContactsResponse, error)
	...
	UpdateAccountContacts(ctx context.Context, in *UpdateAccountContactsRequest, opts ...grpc.CallOption) (*UpdateAccountContactsResponse, error)
...
func (c *authClient) GetAccountContacts(ctx context.Context, in *GetAccountContactsRequest, opts ...grpc.CallOption) (*GetAccountContactsResponse, error) {
	out := new(GetAccountContactsResponse)
	err := grpc.Invoke(ctx, "/auth.Auth/GetAccountContacts", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) UpdateAccountContacts(ctx context.Context, in *UpdateAccountContactsRequest, opts ...grpc.CallOption) (*UpdateAccountContactsResponse, error) {
	out := new(UpdateAccountContactsResponse)
	err := grpc.Invoke(ctx, "/auth.Auth/UpdateAccountContacts", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	GetAccountContacts(context.Context, *GetAccountContactsRequest) (*GetAccountContactsResponse, error)
	...
	UpdateAccountContacts(context.Context, *UpdateAccountContactsRequest) (*UpdateAccountContactsResponse, error)
...
func _Auth_GetAccountContacts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAccountContactsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).GetAccountContacts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/GetAccountContacts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).GetAccountContacts(ctx, req.(*GetAccountContactsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Auth_UpdateAccountContacts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateAccountContactsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).UpdateAccountContacts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/UpdateAccountContacts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).UpdateAccountContacts(ctx, req.(*UpdateAccountContactsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Auth_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Auth_GetAccountContacts_Handler,
		},
		{
		...
		{
			MethodName: "UpdateAccountContacts",
			Handler:    _Auth_UpdateAccountContacts_Handler,
		},
		{
...
func (m *GetAccountRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Key != nil {
		nn9, err := m.Key.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn9
...
func (m *GetAccountRequest_ID) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x12
	i++
	i = encodeVarintSvc(dAtA, i, uint64(len(m.ID)))
...
func (m *GetAccountRequest_Email) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x1a
	i++
	i = encodeVarintSvc(dAtA, i, uint64(len(m.Email)))
...
func (m *CreateVerificationCodeResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VerificationCode != nil {
		...
		n11, err := m.VerificationCode.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *BlockAccountResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Account != nil {
		...
		i++
		i = encodeVarintSvc(dAtA, i, uint64(m.Account.Size()))
		n13, err := m.Account.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *GetAccountRequest_ID) Size() (n int) {
	var l int
	_ = l
	l = len(m.ID)
	n += 1 + l + sovSvc(uint64(l))
...
func (m *GetAccountRequest_Email) Size() (n int) {
	var l int
	_ = l
	l = len(m.Email)
	n += 1 + l + sovSvc(uint64(l))
...
func (m *GetAccountContactsRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.AccountID)
	if l > 0 {
...
func (m *GetAccountContactsResponse) Size() (n int) {
	var l int
	_ = l
	l = len(m.Email)
	if l > 0 {
...
func (m *UpdateAccountContactsRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.AccountID)
	if l > 0 {
...
func (m *UpdateAccountContactsResponse) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (this *GetAccountRequest_ID) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetAccountRequest_ID{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetAccountRequest_Email) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetAccountRequest_Email{`,
		`Email:` + fmt.Sprintf("%v", this.Email) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GetAccountContactsRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetAccountContactsRequest{`,
		`AccountID:` + fmt.Sprintf("%v", this.AccountID) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetAccountContactsResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetAccountContactsResponse{`,
		`Email:` + fmt.Sprintf("%v", this.Email) + `,`,
		`PhoneNumber:` + fmt.Sprintf("%v", this.PhoneNumber) + `,`,
		`}`,
	}, "")
...
func (this *UpdateAccountContactsRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateAccountContactsRequest{`,
		`AccountID:` + fmt.Sprintf("%v", this.AccountID) + `,`,
		`PhoneNumber:` + fmt.Sprintf("%v", this.PhoneNumber) + `,`,
		`Email:` + fmt.Sprintf("%v", this.Email) + `,`,
		`}`,
...
func (this *UpdateAccountContactsResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateAccountContactsResponse{`,
		`}`,
	}, "")
	return s
}
...
func (m *GetAccountRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Key = &GetAccountRequest_ID{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Email", wireType)
			...
			m.Key = &GetAccountRequest_Email{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSvc(dAtA[iNdEx:])
...
func (m *GetAccountContactsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetAccountContactsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetAccountContactsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetAccountContactsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetAccountContactsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetAccountContactsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *UpdateAccountContactsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateAccountContactsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateAccountContactsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *UpdateAccountContactsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateAccountContactsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateAccountContactsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorSvc = []byte{
	...
	,
}
