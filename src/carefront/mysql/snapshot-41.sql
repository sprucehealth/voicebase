...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_8711
-- ------------------------------------------------------
...
CREATE TABLE `treatment` (
  ...
  `additional_drug_db_ids` int(10) unsigned NOT NULL,
  ...
  KEY `additional_drug_db_ids` (`additional_drug_db_ids`),
  ...
  CONSTRAINT `treatment_ibfk_2` FOREIGN KEY (`additional_drug_db_ids`) REFERENCES `drug_db_id` (`id`),
...
-- Dump completed on 2013-12-24 11:28:59
