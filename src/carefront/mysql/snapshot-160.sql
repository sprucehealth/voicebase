...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_13502
-- ------------------------------------------------------
...
CREATE TABLE `treatment_dr_favorite_selection` (
  ...
  KEY `treatment_id` (`treatment_id`),
  CONSTRAINT `treatment_dr_favorite_selection_ibfk_1` FOREIGN KEY (`dr_favorite_treatment_id`) REFERENCES `dr_treatment_template` (`id`),
...
-- Dump completed on 2014-02-19 10:53:27
