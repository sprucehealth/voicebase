...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_10147
-- ------------------------------------------------------
...
CREATE TABLE `dr_favorite_treatment` (
  ...
  CONSTRAINT `dr_favorite_treatment_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  CONSTRAINT `dr_favorite_treatment_ibfk_2` FOREIGN KEY (`treatment_id`) REFERENCES `treatment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `treatment_dr_favorite_selection`
--

DROP TABLE IF EXISTS `treatment_dr_favorite_selection`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `treatment_dr_favorite_selection` (
  ...
  KEY `treatment_id` (`treatment_id`),
  CONSTRAINT `treatment_dr_favorite_selection_ibfk_1` FOREIGN KEY (`dr_favorite_treatment_id`) REFERENCES `dr_favorite_treatment` (`id`),
  CONSTRAINT `treatment_dr_favorite_selection_ibfk_2` FOREIGN KEY (`treatment_id`) REFERENCES `treatment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-02-14 23:15:55
