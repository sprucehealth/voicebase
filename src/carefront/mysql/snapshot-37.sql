...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_2637
-- ------------------------------------------------------
...
--
-- Table structure for table `dr_diagnosis_intake`
--

DROP TABLE IF EXISTS `dr_diagnosis_intake`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dr_diagnosis_intake` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `parent_diagnosis_intake` int(10) unsigned DEFAULT NULL,
  `parent_question_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `parent_diagnosis_intake` (`parent_diagnosis_intake`),
  ...
  CONSTRAINT `dr_diagnosis_intake_ibfk_1` FOREIGN KEY (`parent_diagnosis_intake`) REFERENCES `dr_diagnosis_intake` (`id`),
  CONSTRAINT `dr_diagnosis_intake_ibfk_2` FOREIGN KEY (`parent_question_id`) REFERENCES `question` (`id`),
  CONSTRAINT `dr_diagnosis_intake_ibfk_3` FOREIGN KEY (`layout_version_id`) REFERENCES `layout_version` (`id`),
  CONSTRAINT `dr_diagnosis_intake_ibfk_4` FOREIGN KEY (`potential_answer_id`) REFERENCES `potential_answer` (`id`),
  CONSTRAINT `dr_diagnosis_intake_ibfk_5` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`),
  CONSTRAINT `dr_diagnosis_intake_ibfk_6` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  CONSTRAINT `dr_diagnosis_intake_ibfk_7` FOREIGN KEY (`patient_visit_id`) REFERENCES `patient_visit` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-12-19 13:12:47
