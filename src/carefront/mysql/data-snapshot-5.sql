...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_11588
-- ------------------------------------------------------
...
INSERT INTO `question_type` VALUES (3,'q_type_compound'),(2,'q_type_free_text'),(1,'q_type_multiple_choice'),(7,'q_type_multiple_photo'),(8,'q_type_segmented_control'),(5,'q_type_single_entry'),(4,'q_type_single_photo'),(6,'q_type_single_select');
...
CREATE TABLE `potential_answer` (
  ...
  UNIQUE KEY `question_id` (`question_id`,`answer_localized_text_id`),
  ...
  CONSTRAINT `potential_answer_ibfk_3` FOREIGN KEY (`answer_localized_text_id`) REFERENCES `app_text` (`id`)
...
INSERT INTO `potential_answer` VALUES (1,1,2,1,'a_acne',0),(2,1,3,1,'a_something_else',1),(3,2,4,3,'a_condition_entry',0),(4,3,6,1,'a_less_six_months',0),(5,3,7,1,'a_six_twelve_months',1),(6,3,8,1,'a_one_twa_years',2),(7,3,9,1,'a_twa_plus_years',3),(8,4,11,1,'a_yes_acne_worse',0),(9,4,12,1,'a_na_acne_worse',1),(11,6,13,2,'a_changes_acne_worse',0),(12,7,17,1,'a_prescription_prev_treatment_type',0),(13,7,16,1,'a_otc_prev_treatment_type',1),(14,7,18,1,'a_na_prev_treatment_type',2),(15,8,19,5,'a_prev_treatment_list_entry',0),(16,8,103,6,'a_prev_treatment_phota_entry',1),(17,9,21,2,'a_anything_else_acne',0),(18,10,11,1,'a_yes_pregnancy_planning',0),(19,10,12,1,'a_na_pregnancy_planning',1),(20,11,11,1,'a_yes_allergic_medications',0),(21,11,12,1,'a_na_allergic_medications',1),(22,12,29,1,'a_add_allergic_medication',0),(23,13,33,1,'a_list_medications_entry',0),(24,14,35,1,'a_smoke_social_history',0),(25,14,36,1,'a_alcohol_social_history',1),(26,14,37,1,'a_tanning_social_history',2),(27,15,11,1,'a_yes_prev_skin_diagnosis',0),(28,15,12,1,'a_na_prev_skin_diagnosis',1),(29,17,39,1,'a_alopecia_skin_diagnosis',0),(30,17,40,1,'a_acne_skin_diagnosis',1),(31,17,41,1,'a_eczema_skin_diagnosis',2),(32,17,42,1,'a_psoriasis_skin_diagnosis',3),(33,17,43,1,'a_rosacea_skin_diagnosis',4),(34,17,44,1,'a_skin_cancer_diagnosis',5),(35,17,45,1,'a_other_skin_iagnosis',6),(36,16,48,1,'a_arthritis_diagnosis',0),(37,16,49,1,'a_heart_valve_diagnosis',1),(38,16,50,1,'a_artificial_join__diagnosis',2),(39,16,51,1,'a_asthma_diagnosis',3),(40,16,52,1,'a_blood_clots_diagnosis',4),(41,16,53,1,'a_diabetes_diagnosis',5),(42,16,54,1,'a_epilepsey_diagnosis',6),(43,16,55,1,'a_high_blood_pressure_diagnosis',7),(44,16,56,1,'a_high_cholestrol_diagnosis',8),(45,16,57,1,'a_hiv_diagnosis',9),(46,16,58,1,'a_heart_attack_diagnosis',10),(47,16,59,1,'a_heart_murmur_diagnosis',11),(48,16,60,1,'a_irregular_heart_beat_skin_diagnosis',12),(49,16,61,1,'a_kidney_disease_diagnosis',13),(50,16,62,1,'a_liver_disease_diagnosis',14),(51,16,63,1,'a_lung_disease_diagnosis',15),(52,16,64,1,'a_lupus_disease_diagnosis',16),(53,16,65,1,'a_organ_transplant_diagnosis',17),(55,16,66,1,'a_pacemaker_diagnosis',18),(56,16,67,1,'a_thyroid_diagnosis',19),(57,16,68,1,'a_other_skin_diagnosis',20),(58,16,69,1,'a_none_skin_diagnosis',21),(59,18,71,1,'a_face_acne_location',0),(60,18,72,1,'a_chest_acne_location',1),(61,18,73,1,'a_back_acne_location',2),(62,18,74,1,'a_other_acne_location',3),(63,19,82,7,'a_face_front_phota_intake',0),(64,19,84,10,'a_face_right_phota_intake',1),(65,19,83,8,'a_face_left_phota_intake',2),(66,20,85,12,'a_chest_phota_intake',0),(68,21,86,11,'a_back_phota_intake',0),(69,22,109,13,'a_other_phota_intake',0),(70,24,111,14,'a_effective_treatment_not_very',0),(71,24,112,14,'a_effective_treatment_somewhat',1),(72,24,113,14,'a_effective_treatment_very',2),(73,25,11,14,'a_using_treatment_yes',0),(75,25,12,14,'a_using_treatment_no',1),(76,26,115,14,'a_length_treatment_less_one',0),(77,26,116,14,'a_length_treatment_two_five_months',1),(78,26,117,14,'a_length_treatment_six_eleven_months',2),(79,26,118,14,'a_length_treatment_twelve_plus_months',3),(80,27,130,1,'a_puberty',0),(81,27,131,1,'a_onset_six_months',1),(82,27,132,1,'a_onset_one_two_years',2),(83,27,133,1,'a_onset_more_two_years',3),(84,28,136,1,'a_painful_touch',0),(85,28,137,1,'a_scarring',1),(86,28,138,1,'a_discoloration',2),(87,29,11,1,'a_acne_worse_yes',0),(88,29,12,1,'a_acne_worse_no',1),(89,30,11,1,'a_periods_regular_yes',0),(90,30,12,1,'a_periods_regular_no',1),(91,31,144,1,'a_normal_skin',0),(92,31,145,1,'a_oil_skin',1),(93,31,146,1,'a_dry_skin',2),(94,31,147,1,'a_combination_skin',3),(95,32,11,1,'a_topical_allergic_medication_yes',0),(96,32,12,1,'a_topical_allergic_medication_no',1),(97,33,153,1,'a_other_condition_acne_gastiris',0),(98,33,154,1,'a_other_condition_acne_colitis',1),(99,33,155,1,'a_other_condition_acne_kidney_condition',2),(100,33,156,1,'a_other_condition_acne_lupus',3);
...
-- Dump completed on 2013-12-03  0:42:18
