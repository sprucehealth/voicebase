...
CREATE TABLE `patient_visit_provider_assignment` (
  ...
  KEY `provider_role_id` (`provider_role_id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `patient_visit_provider_assignment_ibfk_4` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`),
...
CREATE TABLE `patient_visit_provider_group` (
  ...
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `patient_visit_provider_group_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-12-18 13:03:14
