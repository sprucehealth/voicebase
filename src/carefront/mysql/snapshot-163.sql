...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_16725
-- ------------------------------------------------------
...
CREATE TABLE `pharmacy_dispensed_treatment` (
  ...
  CONSTRAINT `pharmacy_dispensed_treatment_ibfk_1` FOREIGN KEY (`treatment_id`) REFERENCES `treatment` (`id`),
  ...
  CONSTRAINT `pharmacy_dispensed_treatment_ibfk_5` FOREIGN KEY (`dispense_unit_id`) REFERENCES `dispense_unit` (`id`),
...
CREATE TABLE `unlinked_requested_treatment` (
  ...
  CONSTRAINT `unlinked_requested_treatment_ibfk_4` FOREIGN KEY (`dispense_unit_id`) REFERENCES `dispense_unit` (`id`),
...
-- Dump completed on 2014-02-21 14:23:12
