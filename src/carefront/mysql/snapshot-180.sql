...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_29359
-- ------------------------------------------------------
...
CREATE TABLE `erx_status_events` (
  ...
  `reported_timestamp` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `treatment_id` (`treatment_id`),
...
-- Dump completed on 2014-03-20 15:39:05
