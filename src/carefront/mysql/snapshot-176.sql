...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_14571
-- ------------------------------------------------------
...
CREATE TABLE `pharmacy_dispensed_treatment` (
  ...
  `unlinked_requested_treatment_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `treatment_id` (`treatment_id`),
  KEY `drug_name_id` (`drug_name_id`),
  KEY `drug_route_id` (`drug_route_id`),
  ...
  KEY `unlinked_requested_treatment_id` (`unlinked_requested_treatment_id`),
  CONSTRAINT `pharmacy_dispensed_treatment_ibfk_7` FOREIGN KEY (`unlinked_requested_treatment_id`) REFERENCES `unlinked_requested_treatment` (`id`),
...
CREATE TABLE `rx_refill_request` (
  ...
  `requested_refill_amount` int(10) unsigned NOT NULL,
  ...
  KEY `doctor_id` (`doctor_id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `rx_refill_request_ibfk_1` FOREIGN KEY (`requested_treatment_id`) REFERENCES `treatment` (`id`),
  CONSTRAINT `rx_refill_request_ibfk_2` FOREIGN KEY (`dispensed_treatment_id`) REFERENCES `pharmacy_dispensed_treatment` (`id`),
  CONSTRAINT `rx_refill_request_ibfk_3` FOREIGN KEY (`unlinked_requested_treatment_id`) REFERENCES `unlinked_requested_treatment` (`id`),
...
CREATE TABLE `rx_refill_status_events` (
  ...
  CONSTRAINT `rx_refill_status_events_ibfk_2` FOREIGN KEY (`reason_id`) REFERENCES `deny_refill_reason` (`id`),
...
--
-- Table structure for table `unlinked_requested_treatment`
--

DROP TABLE IF EXISTS `unlinked_requested_treatment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unlinked_requested_treatment` (
  ...
  KEY `drug_form_id` (`drug_form_id`),
  KEY `pharmacy_id` (`pharmacy_id`),
  CONSTRAINT `unlinked_requested_treatment_ibfk_1` FOREIGN KEY (`drug_name_id`) REFERENCES `drug_name` (`id`),
  CONSTRAINT `unlinked_requested_treatment_ibfk_2` FOREIGN KEY (`drug_route_id`) REFERENCES `drug_route` (`id`),
  CONSTRAINT `unlinked_requested_treatment_ibfk_3` FOREIGN KEY (`drug_form_id`) REFERENCES `drug_form` (`id`),
  CONSTRAINT `unlinked_requested_treatment_ibfk_5` FOREIGN KEY (`pharmacy_id`) REFERENCES `pharmacy_selection` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `unlinked_requested_treatment_drug_db_id`
--

DROP TABLE IF EXISTS `unlinked_requested_treatment_drug_db_id`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unlinked_requested_treatment_drug_db_id` (
  ...
  `drug_db_id` int(10) unsigned NOT NULL,
  `drug_db_id_tag` varchar(100) NOT NULL,
  `unlinked_requested_treatment_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `unlinked_requested_treatment_id` (`unlinked_requested_treatment_id`),
  CONSTRAINT `unlinked_requested_treatment_drug_db_id_ibfk_1` FOREIGN KEY (`unlinked_requested_treatment_id`) REFERENCES `unlinked_requested_treatment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-02-28 18:17:09
