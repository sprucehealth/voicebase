...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_6600
-- ------------------------------------------------------
...
--
-- Table structure for table `carefront_region`
--

DROP TABLE IF EXISTS `carefront_region`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `carefront_region` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `carefront_region`
--

LOCK TABLES `carefront_region` WRITE;
/*!40000 ALTER TABLE `carefront_region` DISABLE KEYS */;
INSERT INTO `carefront_region` VALUES (1,'us-east-1'),(2,'us-west-1');
/*!40000 ALTER TABLE `carefront_region` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `object_storage` (
  ...
  CONSTRAINT `object_storage_ibfk_1` FOREIGN KEY (`region_id`) REFERENCES `carefront_region` (`id`)
...
-- Dump completed on 2013-12-01 15:53:56
