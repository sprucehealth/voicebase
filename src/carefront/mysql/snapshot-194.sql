...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_9361
-- ------------------------------------------------------
...
CREATE TABLE `pharmacy_dispensed_treatment` (
  ...
  `dispense_value` decimal(6,3) NOT NULL,
...
CREATE TABLE `rx_refill_status_events` (
  ...
  `status` varchar(100) NOT NULL,
  `rx_refill_status_date` timestamp(6) NOT NULL,
  `reported_timestamp` timestamp(6) NULL DEFAULT NULL,
...
CREATE TABLE `unlinked_dntf_treatment_drug_db_id` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `drug_db_id` int(10) unsigned NOT NULL,
  `drug_db_id_tag` int(10) unsigned NOT NULL,
...
-- Dump completed on 2014-04-02 15:20:56
