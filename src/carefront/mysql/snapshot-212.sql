...
--
-- Host: 127.0.0.1    Database: database_11437
-- ------------------------------------------------------
...
--
-- Table structure for table `dr_favorite_treatment_drug_db_ids_group_mapping`
--

DROP TABLE IF EXISTS `dr_favorite_treatment_drug_db_ids_group_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dr_favorite_treatment_drug_db_ids_group_mapping` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `drug_db_ids_group_id` int(10) unsigned NOT NULL,
  `dr_favorite_treatment_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `drug_db_ids_group_id` (`drug_db_ids_group_id`),
  KEY `dr_favorite_treatment_id` (`dr_favorite_treatment_id`),
  CONSTRAINT `dr_favorite_treatment_drug_db_ids_group_mapping_ibfk_1` FOREIGN KEY (`drug_db_ids_group_id`) REFERENCES `drug_db_ids_group` (`id`),
  CONSTRAINT `dr_favorite_treatment_drug_db_ids_group_mapping_ibfk_2` FOREIGN KEY (`dr_favorite_treatment_id`) REFERENCES `dr_favorite_treatment` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `dr_treatment_template_drug_db_ids_group_mapping`
--

DROP TABLE IF EXISTS `dr_treatment_template_drug_db_ids_group_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dr_treatment_template_drug_db_ids_group_mapping` (
  ...
  CONSTRAINT `dr_treatment_template_drug_db_ids_group_mapping_ibfk_1` FOREIGN KEY (`drug_db_ids_group_id`) REFERENCES `drug_db_ids_group` (`id`),
  CONSTRAINT `dr_treatment_template_drug_db_ids_group_mapping_ibfk_2` FOREIGN KEY (`dr_treatment_template_id`) REFERENCES `dr_treatment_template` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `drug_db_id` (
  ...
  PRIMARY KEY (`id`),
  KEY `drug_db_ids_group_id` (`drug_db_ids_group_id`),
  CONSTRAINT `drug_db_id_ibfk_2` FOREIGN KEY (`drug_db_ids_group_id`) REFERENCES `drug_db_ids_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `drug_db_ids_group`
--

DROP TABLE IF EXISTS `drug_db_ids_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `pharmacy_dispensed_treatment_drug_db_ids_group_mapping`
--

DROP TABLE IF EXISTS `pharmacy_dispensed_treatment_drug_db_ids_group_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pharmacy_dispensed_treatment_drug_db_ids_group_mapping` (
  ...
  CONSTRAINT `pharmacy_dispensed_treatment_drug_db_ids_group_mapping_ibfk_1` FOREIGN KEY (`drug_db_ids_group_id`) REFERENCES `drug_db_ids_group` (`id`),
  CONSTRAINT `pharmacy_dispensed_treatment_drug_db_ids_group_mapping_ibfk_2` FOREIGN KEY (`pharmacy_dispensed_treatment_id`) REFERENCES `pharmacy_dispensed_treatment` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `requested_treatment_drug_db_ids_group_mapping`
--

DROP TABLE IF EXISTS `requested_treatment_drug_db_ids_group_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `requested_treatment_drug_db_ids_group_mapping` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `drug_db_ids_group_id` int(10) unsigned NOT NULL,
  `requested_treatment_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `drug_db_ids_group_id` (`drug_db_ids_group_id`),
  KEY `requested_treatment_id` (`requested_treatment_id`),
  CONSTRAINT `requested_treatment_drug_db_ids_group_mapping_ibfk_1` FOREIGN KEY (`drug_db_ids_group_id`) REFERENCES `drug_db_ids_group` (`id`),
  CONSTRAINT `requested_treatment_drug_db_ids_group_mapping_ibfk_2` FOREIGN KEY (`requested_treatment_id`) REFERENCES `requested_treatment` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `treatment` (
  ...
  KEY `drug_route_id` (`drug_route_id`),
  KEY `pharmacy_id` (`pharmacy_id`),
  CONSTRAINT `treatment_ibfk_10` FOREIGN KEY (`treatment_plan_id`) REFERENCES `treatment_plan` (`id`),
...
--
-- Table structure for table `treatment_drug_db_ids_group_mapping`
--

DROP TABLE IF EXISTS `treatment_drug_db_ids_group_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `treatment_drug_db_ids_group_mapping` (
  ...
  KEY `drug_db_ids_group_id` (`drug_db_ids_group_id`),
  KEY `treatment_id` (`treatment_id`),
  CONSTRAINT `treatment_drug_db_ids_group_mapping_ibfk_1` FOREIGN KEY (`drug_db_ids_group_id`) REFERENCES `drug_db_ids_group` (`id`),
  CONSTRAINT `treatment_drug_db_ids_group_mapping_ibfk_2` FOREIGN KEY (`treatment_id`) REFERENCES `treatment` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `unlinked_dntf_treatment_drug_db_ids_group_mapping`
--

DROP TABLE IF EXISTS `unlinked_dntf_treatment_drug_db_ids_group_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unlinked_dntf_treatment_drug_db_ids_group_mapping` (
  ...
  KEY `drug_db_ids_group_id` (`drug_db_ids_group_id`),
  KEY `unlinked_dntf_treatment_id` (`unlinked_dntf_treatment_id`),
  CONSTRAINT `unlinked_dntf_treatment_drug_db_ids_group_mapping_ibfk_1` FOREIGN KEY (`drug_db_ids_group_id`) REFERENCES `drug_db_ids_group` (`id`),
  CONSTRAINT `unlinked_dntf_treatment_drug_db_ids_group_mapping_ibfk_2` FOREIGN KEY (`unlinked_dntf_treatment_id`) REFERENCES `unlinked_dntf_treatment` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-04-29 22:17:11
