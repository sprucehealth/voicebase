...
--
-- Host: dev-db-3.ccvrwjdx3gvp.us-east-1.rds.amazonaws.com    Database: database_3064
-- ------------------------------------------------------
...
CREATE TABLE `question` (
  ...
  `formatted_field_tag` varchar(150) NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2014-01-09 12:52:29
