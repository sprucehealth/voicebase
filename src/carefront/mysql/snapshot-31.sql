...
CREATE TABLE `doctor` (
  ...
  `provider_role_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `account_id` (`account_id`),
  KEY `provider_role_id` (`provider_role_id`),
  CONSTRAINT `doctor_ibfk_2` FOREIGN KEY (`provider_role_id`) REFERENCES `provider_role` (`id`),
...
--
-- Table structure for table `patient_visit_provider_assignment`
--

DROP TABLE IF EXISTS `patient_visit_provider_assignment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patient_visit_provider_assignment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `patient_visit_id` int(10) unsigned NOT NULL,
  `provider_role_id` int(10) unsigned NOT NULL,
  `provider_id` int(10) unsigned NOT NULL,
  ...
  KEY `provider_role_id` (`provider_role_id`),
  CONSTRAINT `patient_visit_provider_assignment_ibfk_1` FOREIGN KEY (`patient_visit_id`) REFERENCES `patient_visit` (`id`),
  CONSTRAINT `patient_visit_provider_assignment_ibfk_2` FOREIGN KEY (`assignment_group_id`) REFERENCES `patient_visit_provider_group` (`id`),
  CONSTRAINT `patient_visit_provider_assignment_ibfk_3` FOREIGN KEY (`provider_role_id`) REFERENCES `provider_role` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `patient_visit_provider_group`
--

DROP TABLE IF EXISTS `patient_visit_provider_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patient_visit_provider_group` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `patient_visit_id` int(10) unsigned NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `patient_visit_id` (`patient_visit_id`),
  CONSTRAINT `patient_visit_provider_group_ibfk_1` FOREIGN KEY (`patient_visit_id`) REFERENCES `patient_visit` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-12-17  5:57:38
