...
func SignupRandomTestDoctor(t *testing.T, dataApi api.DataAPI, authApi thriftapi.Auth) *apiservice.DoctorSignedupResponse {
	...
	requestBody.WriteString("@example.com&password=12345&dob=11/08/1987&gender=male")
