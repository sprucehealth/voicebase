...
func (d *DataService) AddTreatmentsForPatientVisit(treatments []*common.Treatment, doctorId, treatmentPlanId int64) error {
	...
	for _, treatment := range treatments {
		...
		if treatment.DoctorFavoriteTreatmentId.Int64() != 0 {
...
func (d *DataService) addTreatment(treatment *common.Treatment, asFavorite bool, tx *sql.Tx) error {
	...
	if treatment.TreatmentPlanId.Int64() != 0 && !asFavorite {
...
func (d *DataService) GetTreatmentsBasedOnTreatmentPlanId(patientVisitId, treatmentPlanId int64) ([]*common.Treatment, error) {
	...
	for _, treatment := range treatments {
		if treatmentIdToFavoriteIdMapping[treatment.Id.Int64()] != 0 {
			treatment.DoctorFavoriteTreatmentId = common.NewObjectId(treatmentIdToFavoriteIdMapping[treatment.Id.Int64()])
		}
	}
