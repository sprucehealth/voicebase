...
var mutationType = graphql.NewObject(graphql.ObjectConfig{
	...
	Fields: graphql.Fields{
		...
		"cloneMessage":                        cloneMessageMutation,
		...
		"deleteSavedMessage":                  deleteSavedMessageMutation,
		"deleteScheduledMessage":              deleteScheduledMessageMutation,
		"deleteThread":                        deleteThreadMutation,
		"deleteVisit":                         deleteVisitMutation,
		...
		"saveMessage":                         saveMessageMutation,
		"scheduleMessage":                     scheduleMessageMutation,
