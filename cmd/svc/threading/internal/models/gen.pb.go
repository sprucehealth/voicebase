...
func (*MessageUpdate) Descriptor() ([]byte, []int) { return fileDescriptorGen, []int{4} }
...
func (*MessageDelete) Descriptor() ([]byte, []int) { return fileDescriptorGen, []int{5} }
...
func init() {
	...
	proto.RegisterType((*MessageUpdate)(nil), "models.MessageUpdate")
	proto.RegisterType((*MessageDelete)(nil), "models.MessageDelete")
...
func (this *MessageUpdate) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&models.MessageUpdate{")
...
func (this *MessageDelete) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&models.MessageDelete{")
	s = append(s, "ThreadItemID: "+fmt.Sprintf("%#v", this.ThreadItemID)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *Expr_Tag) GoString() string {
	...
	s := strings.Join([]string{`&models.Expr_Tag{` +
...
func (m *Expr_Tag) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x2a
	i++
	i = encodeVarintGen(dAtA, i, uint64(len(m.Tag)))
	i += copy(dAtA[i:], m.Tag)
	return i, nil
}
...
var fileDescriptorGen = []byte{
	...
	,
}
