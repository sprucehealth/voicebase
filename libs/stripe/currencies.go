...
func (c *Currency) UnmarshalJSON(b []byte) error {
	...
	// TODO: for now just assume the ISO code is always provided and valid which
	// should be safe for responses from the api. This could do a lookup for the ISO
	// code to also get the name.
	*c = Currency{ISO: s, Name: ""}
	return nil
}
