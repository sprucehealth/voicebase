...
function DownloadAnalyticsCSV(results: any, name: string): void {
...
var AnalyticsQuery = React.createClass({displayName: "AnalyticsQuery",
	...
	onQueryChange: function(e: any) {
		this.setState({query: e.target.value});
	},
	onDownload: function(e: Event) {
		e.preventDefault();
		DownloadAnalyticsCSV(this.state.results, "analytics");
	},
	onSave: function(e) {
		e.preventDefault();
