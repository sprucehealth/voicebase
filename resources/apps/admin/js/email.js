...
module.exports = {
	EmailAdmin: React.createClass({displayName: "EmailAdmin",
		...
		navigateToSomething: function(props: any, typeKey?: string) {
			var t = null;
		...
		loadTemplates: function(typeKey: string) {
		...
		onSaveTemplate: function(templateID: string) {
			this.loadTemplates("");
