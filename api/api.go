...
type FavoriteTreatmentPlanAPI interface {
	UpsertFavoriteTreatmentPlan(ftp *common.FavoriteTreatmentPlan, treatmentPlanID int64) error
...
type IntakeLayoutAPI interface {
	...
	InsertVersionedQuestion(*common.VersionedQuestion, []*common.VersionedAnswer, *common.VersionedAdditionalQuestionField) (int64, error)
