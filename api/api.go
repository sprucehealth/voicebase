...
type IntakeLayoutAPI interface {
	...
	DeleteVersionedAnswer(va *common.VersionedAnswer) (int64, error)
	...
	VersionQuestion(versionedQuestion *common.VersionedQuestion) (int64, error)
	VersionedAnswerFromID(ID int64) (*common.VersionedAnswer, error)
	VersionedAnswersForQuestion(questionID, languageID int64) ([]*common.VersionedAnswer, error)
	VersionedAnswer(answerTag string, questionID, languageID int64) (*common.VersionedAnswer, error)
	VersionedAnswers(answerQueryParams []*AnswerQueryParams) ([]*common.VersionedAnswer, error)
	VersionAnswer(versionedAnswer *common.VersionedAnswer) (int64, int64, error)
