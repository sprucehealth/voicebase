...
--
-- Host: 127.0.0.1    Database: database_26579
-- ------------------------------------------------------
...
CREATE TABLE `doctor_transaction` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `doctor_id_2` (`doctor_id`,`item_type`,`item_id`),
  KEY `patient_id` (`patient_id`),
...
CREATE TABLE `patient_receipt` (
  ...
  `item_cost_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `patient_id` (`patient_id`,`item_id`,`item_type`),
...
-- Dump completed on 2014-09-22 17:26:17
