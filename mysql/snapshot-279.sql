...
--
-- Host: 127.0.0.1    Database: database_30851
-- ------------------------------------------------------
...
CREATE TABLE `doctor_treatment_message` (
  ...
  CONSTRAINT `doctor_treatment_message_ibfk_1` FOREIGN KEY (`treatment_plan_id`) REFERENCES `treatment_plan` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-07-22 11:33:31
