...
--
-- Host: 127.0.0.1    Database: database_16803
-- ------------------------------------------------------
...
--
-- Table structure for table `attribution_data`
--
...
CREATE TABLE `care_providing_state` (
  ...
  KEY `clinical_pathway_id` (`clinical_pathway_id`),
  KEY `state` (`state`),
  KEY `fk_care_providing_state_state_id` (`state_id`),
  CONSTRAINT `care_providing_state_ibfk_2` FOREIGN KEY (`clinical_pathway_id`) REFERENCES `clinical_pathway` (`id`),
  CONSTRAINT `fk_care_providing_state_state_id` FOREIGN KEY (`state_id`) REFERENCES `state` (`id`)
...
CREATE TABLE `credit_card` (
  ...
  CONSTRAINT `credit_card_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `doctor_queue` (
  ...
  KEY `doctor_queue_patient` (`patient_id`),
  CONSTRAINT `doctor_queue_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  CONSTRAINT `doctor_queue_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `doctor_transaction` (
  ...
  CONSTRAINT `doctor_transaction_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `feedback_template_config`
--

DROP TABLE IF EXISTS `feedback_template_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `ftp_pathway_membership`
--

DROP TABLE IF EXISTS `ftp_pathway_membership`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `health_log` (
  ...
  CONSTRAINT `health_log_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `info_intake` (
  ...
  CONSTRAINT `info_intake_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
...
CREATE TABLE `parent_consent_proof` (
  ...
  CONSTRAINT `parent_consent_proof_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`),
...
CREATE TABLE `patient_address_selection` (
  ...
  CONSTRAINT `patient_address_selection_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_agreement` (
  ...
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `patient_agreement_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_care_provider_assignment` (
  ...
  CONSTRAINT `patient_care_provider_assignment_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_case` (
  ...
  `practice_extension` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `clinical_pathway_id` (`clinical_pathway_id`),
  ...
  CONSTRAINT `patient_case_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_emergency_contact` (
  ...
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `patient_emergency_contact_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_exported_medical_record` (
  ...
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `patient_exported_medical_record_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_feedback` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `feedback_for` (`feedback_for`),
...
CREATE TABLE `patient_location` (
  ...
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `patient_location_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_parent` (
  `patient_id` bigint(20) unsigned NOT NULL,
  `parent_patient_id` bigint(20) unsigned NOT NULL,
  ...
  CONSTRAINT `patient_parent_parent_patient` FOREIGN KEY (`parent_patient_id`) REFERENCES `patient` (`id`),
...
CREATE TABLE `patient_pcp` (
  ...
  `creation_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`patient_id`),
  CONSTRAINT `patient_pcp_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_pharmacy_selection` (
  ...
  CONSTRAINT `patient_pharmacy_selection_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_receipt` (
  ...
  CONSTRAINT `patient_receipt_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `patient_structured_feedback`
--

DROP TABLE IF EXISTS `patient_structured_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patient_structured_feedback` (
  `feedback_template_id` int(10) unsigned NOT NULL,
  `patient_feedback_id` int(10) unsigned NOT NULL,
  `patient_id` bigint(20) unsigned NOT NULL,
  `json_data` blob NOT NULL,
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  CONSTRAINT `patient_structured_feedback_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`),
  CONSTRAINT `patient_structured_feedback_ibfk_3` FOREIGN KEY (`feedback_template_id`) REFERENCES `feedback_template` (`id`),
  CONSTRAINT `patient_structured_feedback_ibfk_4` FOREIGN KEY (`patient_feedback_id`) REFERENCES `patient_feedback` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_visit` (
  ...
  CONSTRAINT `patient_visit_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
...
CREATE TABLE `photo_intake_section` (
  ...
  CONSTRAINT `photo_intake_section_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `practice_model`
--

DROP TABLE IF EXISTS `practice_model`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `practice_model` (
  `doctor_id` int(10) unsigned NOT NULL,
  `spruce_pc` tinyint(1) NOT NULL DEFAULT '0',
  `practice_extension` tinyint(1) NOT NULL DEFAULT '0',
  `state_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`doctor_id`,`state_id`),
  KEY `fk_practice_model_state_id` (`state_id`),
  CONSTRAINT `fk_practice_model_doctor_id` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  CONSTRAINT `fk_practice_model_state_id` FOREIGN KEY (`state_id`) REFERENCES `state` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rx_refill_request` (
  ...
  CONSTRAINT `rx_refill_request_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `rx_reminder`
--

DROP TABLE IF EXISTS `rx_reminder`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rx_reminder` (
  `treatment_id` int(10) unsigned NOT NULL,
  `text` varchar(255) NOT NULL,
  `reminder_interval` varchar(15) NOT NULL,
  `days` varchar(60) DEFAULT NULL,
  `times` varchar(8640) NOT NULL,
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `scheduled_message` (
  ...
  CONSTRAINT `scheduled_message_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `treatment_plan` (
  ...
  CONSTRAINT `treatment_plan_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `treatment_plan_scheduled_message` (
  ...
  `cancelled_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `unclaimed_case_queue` (
  ...
  KEY `unclaimed_case_queue_patient` (`patient_id`),
  ...
  CONSTRAINT `unclaimed_case_queue_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `unlinked_dntf_treatment` (
  ...
  CONSTRAINT `unlinked_dntf_treatment_patient` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-11-11 13:52:19
