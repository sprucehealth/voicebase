...
--
-- Host: 127.0.0.1    Database: database_25448
-- ------------------------------------------------------
...
CREATE TABLE `diagnosis_intake` (
  ...
  CONSTRAINT `diagnosis_intake_ibfk_6` FOREIGN KEY (`parent_info_intake_id`) REFERENCES `diagnosis_intake` (`id`),
...
-- Dump completed on 2014-11-05 15:18:37
