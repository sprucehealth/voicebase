...
--
-- Host: localhost    Database: database_29598
-- ------------------------------------------------------
...
--
-- Table structure for table `diagnosis_code_first_note`
--

DROP TABLE IF EXISTS `diagnosis_code_first_note`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `diagnosis_code_first_note` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `diagnosis_code_id` int(10) unsigned NOT NULL,
  `note` varchar(1024) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `diagnosis_code_id` (`diagnosis_code_id`),
  CONSTRAINT `diagnosis_code_first_note_ibfk_1` FOREIGN KEY (`diagnosis_code_id`) REFERENCES `diagnosis_code` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `diagnosis_details_layout` (
  ...
  CONSTRAINT `diagnosis_details_layout_ibfk_1` FOREIGN KEY (`diagnosis_code_id`) REFERENCES `diagnosis_code` (`id`),
...
CREATE TABLE `diagnosis_details_layout_template` (
  ...
  CONSTRAINT `diagnosis_details_layout_template_ibfk_1` FOREIGN KEY (`diagnosis_code_id`) REFERENCES `diagnosis_code` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `diagnosis_excludes1_note`
--

DROP TABLE IF EXISTS `diagnosis_excludes1_note`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `diagnosis_excludes1_note` (
  ...
  PRIMARY KEY (`id`),
  KEY `diagnosis_code_id` (`diagnosis_code_id`),
  CONSTRAINT `diagnosis_excludes1_note_ibfk_1` FOREIGN KEY (`diagnosis_code_id`) REFERENCES `diagnosis_code` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `diagnosis_excludes2_note`
--

DROP TABLE IF EXISTS `diagnosis_excludes2_note`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `diagnosis_excludes2_note` (
  ...
  PRIMARY KEY (`id`),
  KEY `diagnosis_code_id` (`diagnosis_code_id`),
  CONSTRAINT `diagnosis_excludes2_note_ibfk_1` FOREIGN KEY (`diagnosis_code_id`) REFERENCES `diagnosis_code` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `diagnosis_includes_note`
--

DROP TABLE IF EXISTS `diagnosis_includes_note`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `diagnosis_includes_note` (
  ...
  PRIMARY KEY (`id`),
  KEY `diagnosis_code_id` (`diagnosis_code_id`),
  CONSTRAINT `diagnosis_includes_note_ibfk_1` FOREIGN KEY (`diagnosis_code_id`) REFERENCES `diagnosis_code` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `diagnosis_inclusion_term`
--

DROP TABLE IF EXISTS `diagnosis_inclusion_term`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `diagnosis_inclusion_term` (
  ...
  PRIMARY KEY (`id`),
  KEY `diagnosis_code_id` (`diagnosis_code_id`),
  CONSTRAINT `diagnosis_inclusion_term_ibfk_1` FOREIGN KEY (`diagnosis_code_id`) REFERENCES `diagnosis_code` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `diagnosis_use_additional_code_note`
--

DROP TABLE IF EXISTS `diagnosis_use_additional_code_note`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `diagnosis_use_additional_code_note` (
  ...
  PRIMARY KEY (`id`),
  KEY `diagnosis_code_id` (`diagnosis_code_id`),
  CONSTRAINT `diagnosis_use_additional_code_note_ibfk_1` FOREIGN KEY (`diagnosis_code_id`) REFERENCES `diagnosis_code` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `doctor_patient_case_feed`
--

DROP TABLE IF EXISTS `doctor_patient_case_feed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `doctor_patient_case_feed` (
  ...
  KEY `last_event_time` (`last_event_time`),
  KEY `doctor_id` (`doctor_id`,`last_event_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `favorite_treatment_plan_scheduled_message`
--

DROP TABLE IF EXISTS `favorite_treatment_plan_scheduled_message`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `favorite_treatment_plan_scheduled_message` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `favorite_treatment_plan_id` bigint(20) unsigned NOT NULL,
...
--
-- Table structure for table `favorite_treatment_plan_scheduled_message_attachment`
--

DROP TABLE IF EXISTS `favorite_treatment_plan_scheduled_message_attachment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `favorite_treatment_plan_scheduled_message_attachment` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `favorite_treatment_plan_scheduled_message_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE `visit_diagnosis_item` (
  ...
  CONSTRAINT `visit_diagnosis_item_ibfk_2` FOREIGN KEY (`diagnosis_code_id`) REFERENCES `diagnosis_code` (`id`),
...
-- Dump completed on 2014-12-29 13:17:46
