...
--
-- Host: 127.0.0.1    Database: database_21466
-- ------------------------------------------------------
...
CREATE TABLE `patient_structured_feedback` (
  ...
  CONSTRAINT `patient_structured_feedback_ibfk_2` FOREIGN KEY (`patient_feedback_id`) REFERENCES `patient_feedback` (`id`),
...
-- Dump completed on 2015-10-07 15:54:29
