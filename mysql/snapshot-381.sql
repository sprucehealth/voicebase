...
CREATE TABLE `app_version_layout_mapping` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `layout_major` (`layout_major`,`platform`,`role`,`purpose`,`sku_id`),
  KEY `sku_id` (`sku_id`),
...
CREATE TABLE `common_diagnosis_set_item` (
  ...
  `common_diagnosis_set_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `common_diagnosis_set_id` (`common_diagnosis_set_id`,`active`),
  CONSTRAINT `common_diagnosis_set_item_ibfk_1` FOREIGN KEY (`common_diagnosis_set_id`) REFERENCES `common_diagnosis_set` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `doctor_patient_case_feed` (
  ...
  `clinical_pathway_id` int(10) unsigned NOT NULL,
  `clinical_pathway_name` varchar(250) NOT NULL,
  PRIMARY KEY (`patient_id`,`doctor_id`,`case_id`),
  KEY `last_event_time` (`last_event_time`),
  KEY `doctor_id` (`doctor_id`,`last_event_time`),
  KEY `clinical_pathway_id` (`clinical_pathway_id`),
  CONSTRAINT `doctor_patient_case_feed_ibfk_1` FOREIGN KEY (`clinical_pathway_id`) REFERENCES `clinical_pathway` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dr_favorite_treatment_plan` (
  ...
  PRIMARY KEY (`id`),
  KEY `clinical_pathway_id` (`clinical_pathway_id`),
  KEY `doctor_clinical_pathway` (`doctor_id`,`clinical_pathway_id`),
  CONSTRAINT `dr_favorite_treatment_plan_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  CONSTRAINT `dr_favorite_treatment_plan_ibfk_2` FOREIGN KEY (`clinical_pathway_id`) REFERENCES `clinical_pathway` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_doctor_layout_mapping` (
  ...
  `clinical_pathway_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `dr_major` (`dr_major`,`dr_minor`,`patient_major`,`patient_minor`,`sku_id`),
  KEY `sku_id` (`sku_id`),
  KEY `clinical_pathway_id` (`clinical_pathway_id`),
