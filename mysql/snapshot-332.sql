...
--
-- Host: 127.0.0.1    Database: database_32197
-- ------------------------------------------------------
...
CREATE TABLE `app_version_layout_mapping` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `layout_major` (`layout_major`,`health_condition_id`,`platform`,`role`,`purpose`),
...
--
-- Table structure for table `doctor_treatment_message`
--

DROP TABLE IF EXISTS `doctor_treatment_message`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `doctor_treatment_message` (
  ...
  KEY `doctor_id` (`doctor_id`),
  CONSTRAINT `doctor_treatment_message_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  CONSTRAINT `doctor_treatment_message_ibfk_2` FOREIGN KEY (`treatment_plan_id`) REFERENCES `treatment_plan` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `patient_credit`
--

DROP TABLE IF EXISTS `patient_credit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patient_credit` (
  `patient_id` int(10) unsigned NOT NULL,
  `credit` int(10) unsigned NOT NULL,
  `last_checked_patient_credit_history_id` int(10) unsigned NOT NULL,
  `last_modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`patient_id`),
  KEY `last_checked_patient_credit_history_id` (`last_checked_patient_credit_history_id`),
  CONSTRAINT `patient_credit_ibfk_1` FOREIGN KEY (`last_checked_patient_credit_history_id`) REFERENCES `patient_credit_history` (`id`),
  CONSTRAINT `patient_credit_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `patient_credit_history`
--

DROP TABLE IF EXISTS `patient_credit_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patient_credit_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `patient_credit_history_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patient_doctor_layout_mapping` (
  ...
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `dr_major` (`dr_major`,`dr_minor`,`patient_major`,`patient_minor`),
  KEY `health_condition_id` (`health_condition_id`),
...
--
-- Table structure for table `patient_promotion`
--

DROP TABLE IF EXISTS `patient_promotion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patient_promotion` (
  ...
  CONSTRAINT `patient_promotion_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`),
  CONSTRAINT `patient_promotion_ibfk_2` FOREIGN KEY (`promotion_code_id`) REFERENCES `promotion_code` (`id`),
  CONSTRAINT `patient_promotion_ibfk_3` FOREIGN KEY (`promotion_group_id`) REFERENCES `promotion_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `patient_referral_tracking`
--

DROP TABLE IF EXISTS `patient_referral_tracking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patient_referral_tracking` (
  `promotion_code_id` int(10) unsigned NOT NULL,
  `claiming_patient_id` int(10) unsigned NOT NULL,
  ...
  KEY `promotion_code_id` (`promotion_code_id`),
  CONSTRAINT `patient_referral_tracking_ibfk_1` FOREIGN KEY (`referring_account_id`) REFERENCES `account` (`id`),
  CONSTRAINT `patient_referral_tracking_ibfk_2` FOREIGN KEY (`claiming_patient_id`) REFERENCES `patient` (`id`),
  CONSTRAINT `patient_referral_tracking_ibfk_3` FOREIGN KEY (`promotion_code_id`) REFERENCES `promotion_code` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-10-23  7:24:52
